...
const pokemonByTrainer = {
    ...
    'Sixto': [
        { name: 'Absol', image: 'absol.png' },
        { name: 'Aggron', image: 'aggron.png' },
        { name: 'Cacturne', image: 'cacturne.png' },
        { name: 'Crawdaunt', image: 'crawdaunt.png' },
        { name: 'Darmanitan', image: 'darmanitan.png' },
        { name: 'Electivire', image: 'electivire.png' },
        { name: 'Excadrill', image: 'excadrill.png' },
        { name: 'Garchomp', image: 'garchomp.png' },
        ...
        { name: 'Gyarados', image: 'gyarados.png' },
        { name: 'Hariyama', image: 'hariyama.png' },
        { name: 'Huntail', image: 'huntail.png' },
        { name: 'Luxray', image: 'luxray.png' },
        { name: 'Magnezone', image: 'magnezone.png' },
        { name: 'Mandibuzz', image: 'mandibuzz.png' },
        { name: 'Metagross', image: 'metagross.png' },
        { name: 'Mienshao', image: 'mienshao.png' },
        { name: 'Mightyena', image: 'mightyena.png' },
        { name: 'Sableye', image: 'sableye.png' },
        { name: 'Salamence', image: 'salamence.png' },
        { name: 'Scizor', image: 'scizor.png' },
        { name: 'Scolipede', image: 'scolipede.png' },
        { name: 'Scrafty', image: 'scrafty.png' },
        { name: 'Sharpedo', image: 'sharpedo.png' },
        { name: 'Shiftry', image: 'shiftry.png' },
        { name: 'Spiritomb', image: 'spiritomb.png' },
        { name: 'Tentacruel', image: 'tentacruel.png' },
        { name: 'Toxicroak', image: 'toxicroak.png' }
    ],
    'Fatima': [
        { name: 'Arcanine', image: 'arcanine.png' },
        { name: 'Banette', image: 'banette.png' },
        { name: 'Chandelure', image: 'chandelure.png' },
        { name: 'Dusknoir', image: 'dusknoir.png' },
        { name: 'Froslass', image: 'froslass.png' },
        { name: 'Honchkrow', image: 'honchkrow.png' },
        { name: 'Houndoom', image: 'houndoom.png' },
        { name: 'Hydreigon', image: 'hydreigon.png' },
        { name: 'Lucario', image: 'lucario.png' },
        { name: 'Luxray', image: 'luxray.png' },
        { name: 'Mandibuzz', image: 'mandibuzz.png' },
        { name: 'Mawile', image: 'mawile.png' },
        { name: 'Meganium', image: 'meganium.png' },
        { name: 'Mismagius', image: 'mismagius.png' },
        { name: 'Ninetales', image: 'ninetales.png' },
        { name: 'Raichu', image: 'raichu.png' },
        { name: 'Regice', image: 'regice.png' },
        { name: 'Rotom Wash', image: 'rotom_agua.png' },
        { name: 'Sableye', image: 'sableye.png' },
        { name: 'Umbreon', image: 'umbreon.png' }
    ],
    'Nivea': [
        { name: 'Abomasnow', image: 'abomasnow.png' },
        { name: 'Altaria', image: 'altaria.png' },
        { name: 'Beartic', image: 'beartic.png' },
        { name: 'Blissey', image: 'blissey.png' },
        { name: 'Froslass', image: 'froslass.png' },
        { name: 'Gallade', image: 'gallade.png' },
        { name: 'Glalie', image: 'glalie.png' },
        { name: 'Hariyama', image: 'hariyama.png' },
        { name: 'Lanturn', image: 'lanturn.png' },
        { name: 'Metagross', image: 'metagross.png' },
        { name: 'Mienshao', image: 'mienshao.png' },
        { name: 'Mismagius', image: 'mismagius.png' },
        { name: 'Nidoqueen', image: 'nidoqueen.png' },
        { name: 'Serperior', image: 'serperior.png' },
        { name: 'Skarmory', image: 'skarmory.png' },
        { name: 'Togekiss', image: 'togekiss.png' },
        { name: 'Vanilluxe', image: 'vanilluxe.png' },
        { name: 'Walrein', image: 'walrein.png' }
    ],
    'Dracon': [
        { name: 'Aggron', image: 'aggron.png' },
        { name: 'Altaria', image: 'altaria.png' },
        ...
        { name: 'Metagross', image: 'metagross.png' },
        { name: 'Nidoking', image: 'nidoking.png' },
        { name: 'Regirock', image: 'regirock.png' },
        { name: 'Salamence', image: 'salamence.png' },
        { name: 'Sceptile', image: 'sceptile.png' },
        { name: 'Seviper', image: 'seviper.png' },
        { name: 'Torkoal', image: 'torkoal.png' }
    ],
    'Plubio': [
        { name: 'Altaria', image: 'altaria.png' },
        { name: 'Dragonite', image: 'dragonite.png' },
        ...
        { name: 'Gyarados', image: 'gyarados.png' },
        { name: 'Lanturn', image: 'lanturn.png' },
        { name: 'Ludicolo', image: 'ludicolo.png' },
        { name: 'Metagross', image: 'metagross.png' },
        { name: 'Mienshao', image: 'mienshao.png' },
        { name: 'Milotic', image: 'milotic.png' },
        { name: 'Registeel', image: 'registeel.png' },
        { name: 'Roserade', image: 'roserade.png' },
        { name: 'Seaking', image: 'seaking.png' },
        { name: 'Serperior', image: 'serperior.png' },
        { name: 'Starmie', image: 'starmie.png' },
        { name: 'Swampert', image: 'swampert.png' },
        { name: 'Tentacruel', image: 'tentacruel.png' },
        { name: 'Togekiss', image: 'togekiss.png' },
        { name: 'Wailord', image: 'wailord.png' },
        { name: 'Walrein', image: 'walrein.png' },
        { name: 'Whiscash', image: 'whiscash.png' }
    ],
    'Alecran': [
        { name: 'Beautifly', image: 'beautifly.png' },
        { name: 'Crawdaunt', image: 'crawdaunt.png' },
        { name: 'Crustle', image: 'crustle.png' },
        { name: 'Drapion', image: 'drapion.png' },
        { name: 'Durant', image: 'durant.png' },
        { name: 'Dustox', image: 'dustox.png' },
        { name: 'Escavalier', image: 'escavalier.png' },
        { name: 'Ferrothorn', image: 'ferrothorn.png' },
        { name: 'Flygon', image: 'flygon.png' },
        { name: 'Forretress', image: 'forretress.png' },
        { name: 'Gastrodon', image: 'gastrodon.png' },
        { name: 'Gliscor', image: 'gliscor.png' },
        { name: 'Heracross', image: 'heracross.png' },
        { name: 'Kabutops', image: 'kabutops.png' },
        { name: 'Kingler', image: 'kingler.png' },
        { name: 'Octillery', image: 'octillery.png' },
        { name: 'Omastar', image: 'omastar.png' },
        { name: 'Sceptile', image: 'sceptile.png' },
        { name: 'Scizor', image: 'scizor.png' },
        { name: 'Scyther', image: 'scyther.png' },
        { name: 'Skuntank', image: 'skuntank.png' },
        { name: 'Steelix', image: 'steelix.png' },
        { name: 'Tyranitar', image: 'tyranitar.png' },
        { name: 'Vespiquen', image: 'vespiquen.png' },
        { name: 'Volcarona', image: 'volcarona.png' },
        { name: 'Yanmega', image: 'yanmega.png' }
    ],
    'Gaia': [
        { name: 'Absol', image: 'absol.png' },
        { name: 'Amoonguss', image: 'amoonguss.png' },
        { name: 'Blastoise', image: 'blastoise.png' },
        { name: 'Bronzong', image: 'bronzong.png' },
        { name: 'Camerupt', image: 'camerupt.png' },
        { name: 'Cloyster', image: 'cloyster.png' },
        { name: 'Donphan', image: 'donphan.png' },
        { name: 'Druddigon', image: 'druddigon.png' },
        { name: 'Durant', image: 'durant.png' },
        { name: 'Emboar', image: 'emboar.png' },
        { name: 'Forretress', image: 'forretress.png' },
        { name: 'Gengar', image: 'gengar.png' },
        { name: 'Gliscor', image: 'gliscor.png' },
        { name: 'Golem', image: 'golem.png' },
        { name: 'Hippowdon', image: 'hippowdon.png' },
        { name: 'Nidoking', image: 'nidoking.png' },
        { name: 'Parasect', image: 'parasect.png' },
        { name: 'Quagsire', image: 'quagsire.png' },
        { name: 'Rhyperior', image: 'rhyperior.png' },
        ...
        { name: 'Skarmory', image: 'skarmory.png' },
        { name: 'Steelix', image: 'steelix.png' },
        { name: 'Sudowoodo', image: 'sudowoodo.png' },
        { name: 'Tangrowth', image: 'tangrowth.png' },
        { name: 'Walrein', image: 'walrein.png' },
        { name: 'Whiscash', image: 'whiscash.png' }
    ],
    'Fausto': [
        { name: 'Arcanine', image: 'arcanine.png' },
        { name: 'Blaziken', image: 'blaziken.png' },
        { name: 'Bouffalant', image: 'bouffalant.png' },
        { name: 'Bronzong', image: 'bronzong.png' },
        { name: 'Cacturne', image: 'cacturne.png' },
        { name: 'Camerupt', image: 'camerupt.png' },
        { name: 'Charizard', image: 'charizard.png' },
        { name: 'Conkeldurr', image: 'conkeldurr.png' },
        { name: 'Dragonite', image: 'dragonite.png' },
        { name: 'Drifblim', image: 'drifblim.png' },
        { name: 'Entei', image: 'entei.png' },
        { name: 'Flareon', image: 'flareon.png' },
        { name: 'Haxorus', image: 'haxorus.png' },
        { name: 'Houndoom', image: 'houndoom.png' },
        { name: 'Infernape', image: 'infernape.png' },
        { name: 'Lopunny', image: 'lopunny.png' },
        { name: 'Lucario', image: 'lucario.png' },
        { name: 'Ludicolo', image: 'ludicolo.png' },
        { name: 'Magmortar', image: 'magmortar.png' },
        { name: 'Maractus', image: 'maractus.png' },
        { name: 'Medicham', image: 'medicham.png' },
        { name: 'Ninetales', image: 'ninetales.png' },
        { name: 'Rapidash', image: 'rapidash.png' },
        { name: 'Rotom Heat', image: 'rotom_fuego.png' },
        { name: 'Salamence', image: 'salamence.png' },
        { name: 'Steelix', image: 'steelix.png' },
        { name: 'Typhlosion', image: 'typhlosion.png' }
    ...
    'Delos': [
        ...
        { name: 'Golduck', image: 'golduck.png' },
        { name: 'Hydreigon', image: 'hydreigon.png' },
        { name: 'Kecleon', image: 'kecleon.png' },
        { name: 'Lucario', image: 'lucario.png' },
        { name: 'Medicham', image: 'medicham.png' },
        { name: 'Metagross', image: 'metagross.png' },
        { name: 'Mismagius', image: 'mismagius.png' },
        { name: 'Ninetales', image: 'ninetales.png' },
        { name: 'Noctowl', image: 'noctowl.png' },
        { name: 'Raichu', image: 'raichu.png' },
        { name: 'Sigilyph', image: 'sigilyph.png' },
        { name: 'Stantler', image: 'stantler.png' }
    ],
    'Cynthia': [
        { name: 'Aerodactyl', image: 'aerodactyl.png' },
        { name: 'Altaria', image: 'altaria.png' },
        { name: 'Arcanine', image: 'arcanine.png' },
        { name: 'Bastiodon', image: 'bastiodon.png' },
        { name: 'Braviary', image: 'braviary.png' },
        { name: 'Bronzong', image: 'bronzong.png' },
        { name: 'Chandelure', image: 'chandelure.png' },
        { name: 'Clefable', image: 'clefable.png' },
        { name: 'Eelektross', image: 'eelektross.png' },
        ...
        { name: 'Garchomp', image: 'garchomp.png' },
        { name: 'Gastrodon', image: 'gastrodon.png' },
        { name: 'Glaceon', image: 'glaceon.png' },
        { name: 'Heracross', image: 'heracross.png' },
        { name: 'Jellicent', image: 'jellicent.png' },
        { name: 'Lapras', image: 'lapras.png' },
        { name: 'Lickilicky', image: 'lickilicky.png' },
        { name: 'Lucario', image: 'lucario.png' },
        { name: 'Metagross', image: 'metagross.png' },
        { name: 'Milotic', image: 'milotic.png' },
        { name: 'Mismagius', image: 'mismagius.png' },
        { name: 'Nidoqueen', image: 'nidoqueen.png' },
        { name: 'Rayquaza', image: 'rayquaza.png' },
        { name: 'Roserade', image: 'roserade.png' },
        { name: 'Serperior', image: 'serperior.png' },
        { name: 'Spiritomb', image: 'spiritomb.png' },
        { name: 'Togekiss', image: 'togekiss.png' },
    ...
    'Anis': [
        ...
        { name: 'Milotic', image: 'milotic.png' },
        { name: 'Mismagius', image: 'mismagius.png' },
        { name: 'Purugly', image: 'purugly.png' },
        { name: 'Rotom Wash', image: 'rotom_agua.png' },
        { name: 'Toxicroak', image: 'toxicroak.png' },
        { name: 'Umbreon', image: 'umbreon.png' }
    ],
    ...
    'Catleya': [
        ...
        { name: 'Blissey', image: 'blissey.png' },
        { name: 'Bronzong', image: 'bronzong.png' },
        { name: 'Cinccino', image: 'cinccino.png' },
        { name: 'Emolga', image: 'emolga.png' },
        { name: 'Empoleon', image: 'empoleon.png' },
        { name: 'Entei', image: 'entei.png' },
        { name: 'Gothitelle', image: 'gothitelle.png' },
        { name: 'Houndoom', image: 'houndoom.png' },
        { name: 'Jolteon', image: 'jolteon.png' },
        { name: 'Leafeon', image: 'leafeon.png' },
        { name: 'Metagross', image: 'metagross.png' },
        { name: 'Mienshao', image: 'mienshao.png' },
        { name: 'Milotic', image: 'milotic.png' },
        { name: 'Musharna', image: 'musharna.png' },
        { name: 'Nidoqueen', image: 'nidoqueen.png' },
        { name: 'Raichu', image: 'raichu.png' },
        { name: 'Reuniclus', image: 'reuniclus.png' },
        { name: 'Serperior', image: 'serperior.png' },
        { name: 'Sigilyph', image: 'sigilyph.png' },
        { name: 'Slowking', image: 'slowking.png' },
        { name: 'Snorlax', image: 'snorlax.png' },
        { name: 'Staraptor', image: 'staraptor.png' },
        { name: 'Togekiss', image: 'togekiss.png' },
        { name: 'Umbreon', image: 'umbreon.png' },
        { name: 'Vaporeon', image: 'vaporeon.png' }
    ...
    'Lotto': [
        { name: 'Aggron', image: 'aggron.png' },
        { name: 'Breloom', image: 'breloom.png' },
        { name: 'Carracosta', image: 'carracosta.png' },
        { name: 'Conkeldurr', image: 'conkeldurr.png' },
        { name: 'Crawdaunt', image: 'crawdaunt.png' },
        { name: 'Dusknoir', image: 'dusknoir.png' },
        { name: 'Electivire', image: 'electivire.png' },
        ...
        { name: 'Mienshao', image: 'mienshao.png' },
        { name: 'Salamence', image: 'salamence.png' },
        { name: 'Sawk', image: 'sawk.png' },
        { name: 'Seismitoad', image: 'seismitoad.png' },
        { name: 'Skarmory', image: 'skarmory.png' },
        { name: 'Throh', image: 'throh.png' },
        { name: 'Toxicroak', image: 'toxicroak.png' },
        { name: 'Tyranitar', image: 'tyranitar.png' }
    ],
    'Mirto': [
        { name: 'Archeops', image: 'archeops.png' },
        { name: 'Bouffalant', image: 'bouffalant.png' },
        { name: 'Braviary', image: 'braviary.png' },
        { name: 'Chandelure', image: 'chandelure.png' },
        { name: 'Conkeldurr', image: 'conkeldurr.png' },
        ...
        { name: 'Feraligatr', image: 'feraligatr.png' },
        { name: 'Floatzel', image: 'floatzel.png' },
        { name: 'Gigalith', image: 'gigalith.png' },
        { name: 'Krookodile', image: 'krookodile.png' },
        { name: 'Latias', image: 'latias.png' },
        { name: 'Latios', image: 'latios.png' },
        { name: 'Lucario', image: 'lucario.png' },
        { name: 'Manectric', image: 'manectric.png' },
        { name: 'Reuniclus', image: 'reuniclus.png' },
        { name: 'Samurott', image: 'samurott.png' },
        { name: 'Sandslash', image: 'sandslash.png' },
        { name: 'Seismitoad', image: 'seismitoad.png' },
...
function showLeaderPokemons(trainerName, region) {
    ...
    if (!leaderSection || !leaderContainer) return;
